...
class Colors:
    ...
    def __init__(self):
        ...
        hex = ('FF3838', '38ff38', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
...
class Annotator:
    ...
    def box_label(self, ids,  box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                # put ID
                ID_color = (255,255,56)
                cv2.putText(self.im, f'ID:{ids}' , (p1[0], p1[1] - 30 if outside else p1[1] + h -30), 0, self.lw / 3, ID_color,
                            thickness=tf, lineType=cv2.LINE_AA)
